...
#'
#' @param x.lim X-axis (epochs) limits. Default value is \code{x.lim = NULL}.
#'
#' @return None.
#'
#' @examples
...
#'
#' @param class.lbls A vector of class labels to show in the ptSNE plot. Default value is \code{class.lbls = NULL}. If \code{is.null(class.lbls)} and \code{!is.null(bdm$lbls)} the later will be used. If \code{!is.null(bdm$lbls)} and the clustering is performed (i.e. \code{!is.null(bdm$wtt)}) cluster labels are used by default.
#'
