...
#'
#' @param x.lim A vector with upper and lower bounds to limit the number of epochs in the x-axis (NULL by default).
#'
#' @return None.
#'
#' @examples
...
#'
#' @param class.lbls A vector of numeric class labels. If \code{is.null(class.lbls)} and \code{!is.null(bdm$wtt)} cluster labels are used.
#'
#' @param class.pltt A colour palette to show the class labels in the ptSNE plot. If \code{ptsne.pltt = NULL} (default value) the default palette is used.
#'
