...
lbl <- as.matrix(read.csv('./tscLbls.csv', header = FALSE))
```
...
m <- bdm.init(X50, dSet.name = 'Tasic50', ppx = ppx.list, threads = 4, labels = lbl)
```
...
save(m.list, file = '~/omics/tasic/bm450/tsc50.RData')
```
